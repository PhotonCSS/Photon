...
function Card({ children, display, variant, className = "", ...props }) {
    const classes = classnames_1.default("photon-card", `variant-${variant}`, `display-${display}`, className);
...
function CardTitle({ children, subtitle, seperated, className = "", ...props }) {
    const classes = classnames_1.default("card-title", seperated && "seperated", className);
...
function CardSubheader({ children, className = "", ...props }) {
    const classes = classnames_1.default("secondary", className);
...
function CardSubtitle({ children, className = "", ...props }) {
    const classes = classnames_1.default("card-subtitle", className);
...
function CardBody({ children, className = "", ...props }) {
    const classes = classnames_1.default("card-body", className);
    return react_1.default.createElement("p", { className: classes, ...props }, children);
}
...
function CardOverline({ children, className = "", ...props }) {
    const classes = classnames_1.default("overline", className);
    return react_1.default.createElement("p", { className: classes, ...props }, children);
}
...
function CardActions({ children, direction, seperated, className = "", ...props }) {
    const classes = classnames_1.default("card-actions", `direction-${direction}`, seperated && "seperated", className);
